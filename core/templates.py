...
def menu_context_processor(request):
    my_list = [
        ...
        dict(title="Coffee Shop", link=link_creator(request, "/shop/products/")),
        dict(
            title="Restaurant",
            link=link_creator(request, "#"),
            subcategories=[
                dict(title="Breakfast", link=link_creator(request, "/shop/products/restaurant/breakfast")),
                dict(title="Lunch", link=link_creator(request, "/shop/products/restaurant/lunch")),
                dict(title="Dinner", link=link_creator(request, "/shop/products/restaurant/dinner"))
            ]
        )
    ]
