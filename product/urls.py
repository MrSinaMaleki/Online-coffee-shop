...
from .views import ProductListView, ProductCoffeeShopListView, CategoryView, \
    ProductDetailView, ProductDetailAPIView, ProductRestaurantListView
...
urlpatterns = [
    ...
    path('api/list/restaurant', ProductRestaurantListView.as_view(), name='api_product-restaurant-list'),
    ...
    path('restaurant/?<str:time>', TemplateView.as_view(template_name="product/all_products_restaurant.html"),
         name='restaurant'),
]
